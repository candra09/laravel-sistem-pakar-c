                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-between-space">
                                    ...
                                    <div>
                                        <button class="btn btn-primary btn-sm ml-1 edit" data-id="{{ $row->id }}"><i class="fas fa-edit"></i></button>
                                    </div>
        ...
        <div class="modal-body">
            <form action="{{ route('admin.penyakit.update') }}" method="POST">
                ...
                <div class="row mt-2">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="edit-solusi">Keterangan solusi</label>
                            <textarea name="solusi" id="edit-solusi" cols="30" rows="6" class="form-control"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="edit-pencegahan">Keterangan pencegahan</label>
                            <textarea name="pencegahan" id="edit-pencegahan" cols="30" rows="6" class="form-control"></textarea>
                        </div>
                    </div>
                </div>
                <div class="mt-2">
        ...
        $('.info').click(function(e) {
            ...
            $('.edit').click(function() {
                ...
                $.get(`{{ route('admin.penyakit.json') }}?id=${id}`, function(res) {
                    ...
                    $('#edit-solusi').val(res.solusi);
                    $('#edit-pencegahan').val(res.pencegahan);
